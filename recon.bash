...
amass enum --config /home/desca/bb/tools/config.ini --scripts /root/tools/scripts -passive -src -d $i -dir .
...
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/default-logins/ -o $i/default-logins.txt
echo "Scan for default-logins completed." 
echo "Scan for exposures started." 
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/exposures/ -o $i/exposures.txt 
echo "Scan for exposures completed." 
echo "Scan for misconfigurations started."
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/misconfiguration/ -o $i/misconfiguration.txt
echo "Scan for misconfigurations completed." 
echo "Scan for takeovers started." 
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/takeovers/ -o $i/takeovers.txt
echo "Scan for takeovers completed." 
echo "Scan for vulnerabilities started."
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/vulnerabilities/ -o $i/vulnerabilities.txt
echo "Scan for vulnerabilities completed." 
echo "Scan for exposed-panels started."
nuclei -l $i/subdomains.txt -t /home/desca/nuclei-templates/exposed-panels/ -o $i/exposed-panels.txt
